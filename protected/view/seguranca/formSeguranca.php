<div class="col-md-12 col-offset-2">
    <div class="panel panel-primary">
        <div class="panel-heading">Cadastro de Seguranca</div>
        <div class="panel-body">
            <form action="<?php echo $acao; ?>" name="formSeguranca" id="formSeguranca" method="POST" class="form" role="form">
                <div class="row">
                    <div class="col-md-1">
                        <label for="id">Id</label>
                        <input type="text" class="form-control" id="id" name="id" readonly="true" 
                               value="<?php if (isset($seguranca)) echo $seguranca['id']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o Nome" 
                               value="<?php if (isset($seguranca)) echo $seguranca['nome']; ?>" required minlength="3">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Digite o Sobrenome" 
                               value="<?php if (isset($seguranca)) echo $seguranca['sobrenome']; ?>" required minlength="3">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="data" name="datanascimento" placeholder="Informe a Data/Nascimento" 
                                       value="<?php if (isset($seguranca)) echo $seguranca['datanascimento']; ?>" onChange="maiorIdade()" required>
                        <div id="maiordeidade"></div>
                    </div>
                    <div class="col-md-3">
                        <label for="cpf">CPF</label>
                        <input type="text" class="form-control" id="cpf_atualizado" name="cpf" placeholder="Informe o CPF" 
                                       onkeypress="return Onlynumbers(event)" value="<?php if (isset($seguranca)) echo $seguranca['cpf']; ?>" required maxlength="14">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Digite o Telefone" 
                                       value="<?php if (isset($seguranca)) echo $seguranca['telefone']; ?>" required maxlength="20">
                    </div>
                    <div class="col-md-3">
                        <label for="celular">Celular</label>
                        <input type="text" class="form-control" attrname="telephone1" name="celular" placeholder="Digite o Celular" 
                                        value="<?php if (isset($seguranca)) echo $seguranca['celular']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="cnh" name="cnh" placeholder="Digite a CNH" 
                                       value="<?php if (isset($seguranca)) echo $seguranca['cnh']; ?>" required maxlength="20">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Digite o Endereço" 
                                       value="<?php if (isset($seguranca)) echo $seguranca['endereco']; ?>" required maxlength="80">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <select class="form-control" name="idcidade" id="idcidade" required>
                            ...
                            <?php
                                foreach ($listaCidades as $cidades) {
                                    $selected = (isset($seguranca) && $seguranca['idcidade'] == $cidades['id']) ? 'selected' : '';
                                    ?>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Digiteo E-mail" 
                                       value="<?php if (isset($seguranca)) echo $seguranca['email']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="password" class="form-control" attrname="senha" name="senha" placeholder="Digite a Senha" 
                                        value="<?php if (isset($seguranca)) echo $seguranca['senha']; ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="confirmasenha">Confirma Senha</label>
                        <input type="password" class="form-control" attrname="confirmasenha" name="confirmasenha" placeholder="Confirma a Senha" 
                                    onchange="verificarSenhasSeguranca()"    value="<?php if (isset($seguranca)) echo $seguranca['senha']; ?>">
                    </div>
                </div>
    ...
    $("#formSeguranca").validate({
        ...
        messages: {
            nome: {
                ...
                minlength: "O Nome do Segurança deve ter no mínimo 3 caracteres",
                maxlength: "O Nome do Segurança deve ter no máximo 50 caracteres"
            },
            sobrenome: {
                required: "Por favor, informe o Sobrenome",
                minlength: "O Sobrenome do Segurança deve ter no mínimo 3 caracteres",
                maxlength: "O Sobrenome do Segurança deve ter no máximo 50 caracteres"
            },
            datanascimento: {
